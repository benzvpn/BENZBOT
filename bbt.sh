...
msg+="เพื่อเข้าสู่เมนู [ /menu ]\n"
msg+="เพื่อดูข้อมูลเซิร์ฟเวอร์ [ /info ]\n"
msg+="สำหรับบัญชีฟรี [ /free ]\n\n"
msg+="===========================\n"
[[ "${message_from_id[$id]}" != "$Admin_ID" ]] && {
msg+="<b>Acces Token:</b>\n"
msg+="<code>$fcm</code>\n"
        ...
        (
            ...
            if [[ ${message_reply_to_message_message_id[$id]} ]]; then
                ...
                '👤 CREATE USER 👤\n\nUsername:')
                    ...
                    [[ "$sizemax" -gt '10' ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "⛔ Use no maximum 10 characters [EX: benzbotvpn]")" \
                            --parse_mode html
                        >$CAD_ARQ
                        break
                    }
